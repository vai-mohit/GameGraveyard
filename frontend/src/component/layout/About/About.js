        ...
        <div>
          <div>
            <Avatar
              ...
              alt="Founder"
            />
            <h1 className="headingdeal">Welcome To Game Graveyard</h1>
            <Typography>DarkPrinceMohit</Typography>
            <Button onClick={visitInstagram} color="primary">
              Visit Instagram
            </Button>
            <span>This is Game Selling Website made by DarkPrinceMohit.</span>
          </div>
